...
<div class="row">
  ...
  <label for="estado">UF</label>
        ...
        <select name="cidade" id="cidade" value="<?= $linha['cidade']?>">
...
<a href="listarFuncionario.php" type="submit" class="btn btn-warning"><i class="fa-solid fa-rotate-left"></i></i> Voltar</a>
</button>
