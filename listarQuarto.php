...
<div class="input-group mb-3">
  <input type="text" name="numero" id="numero" class="form-control" placeholder="Pesquisar por número" aria-label="Recipient's username" aria-describedby="basic-addon2">
